...
import java.awt.*;
public class BrowseGamesPanel extends JPanel {
    ...
    */
	...
	class MyTableModel extends AbstractTableModel {
		...
		private Object[][] tableData = {
			{new Integer(1), "Mezzanine", "Massive Attack", "Electronica", "Games", "Click", new Boolean(false)},
			{new Integer(2), "Gelb", "Neuroticfish", "Electronica", "Games", "Click", new Boolean(false)},
			{new Integer(3), "Nirvana", "Nevermind", "Rock", "Games", "Click", new Boolean(false)}
		};
		*/
    	...
    	public Object[][] loadTableData() {
    		...
    		for (int i = 0; i < rowsNeeded; i++) {
    			...
    			String[] rowData = db.getLibraryRow(db.GameItems, i); 

...
public class BrowseBooksPanel extends JPanel {
    ...
    */
	...
	class MyTableModel extends AbstractTableModel {
		...
		*/
    	...
    	public Object[][] loadTableData() {
    		...
    		db.loadMediaDatabase(db.BookItems, "Book");
    		...
    		for (int i = 0; i < rowsNeeded; i++) {
    			...
    			String[] rowData = db.getLibraryRow(db.BookItems, i); 
	...
	public void updateStrTableData() {
		...
		DatabaseControl db = new DatabaseControl();
		db.loadMediaDatabase(db.BookItems, "Book");
		int rowsNeeded2 = db.getRowsNeeded(db.BookItems);
                ...
                public void valueChanged(ListSelectionEvent e) {
                    ...
                    if (lsm.isSelectionEmpty()) {
                        ...
                        if (selectedCol == 5) {
                        	...
                        	realRowIndex--;	
                        	description = new DescriptionUI(realRowIndex, "Book");
                        	if(DEBUG) {
